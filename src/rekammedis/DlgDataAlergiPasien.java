...
public class DlgDataAlergiPasien extends javax.swing.JDialog {
    ...
    private PreparedStatement ps, psalergi;
    private ResultSet rs, rsalergi;
    ...
    private void initComponents() {
        ...
        cmbKategory.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Medication", "Makanan", "Lingkungan", "Biologis" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (NoRw.getText().trim().equals("") || NoRM.getText().trim().equals("") || NmPasien.getText().trim().equals("")) {
            ...
            if (Sequel.menyimpantf("alergi_pasien", "?,?,?,?,?,?,?,?,?", "No.Rawat", 9, new String[]{
                NoRw.getText(), Sequel.cariIsi("select CURRENT_TIMESTAMP()"), AlergiCode.getText(), cmbKategory.getSelectedItem().toString(), akses.getkode(), TKeterangan.getText(), ReaksiCode.getText(), cmbSeverity.getSelectedItem().toString(), NoRM.getText()
            }) == true) {
                tampil();
                emptTeks();
...
//                    + "where alergi_pasien.tgl_perawatan between ? and ? "
                    ...
                    + " group by alergi_pasien.no_rawat limit 50");
            try {
...
//                System.out.println(ps.toString());
    ...
    private void getData() {
        ...
        if (tbObat.getSelectedRow() != -1) {
            ...
            String alergi = Sequel.alergi(tbObat.getValueAt(tbObat.getSelectedRow(), 1).toString(), "true");
